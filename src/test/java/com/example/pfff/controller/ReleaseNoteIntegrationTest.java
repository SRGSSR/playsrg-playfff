...
public class ReleaseNoteIntegrationTest {
    ...
    public void changeReleaseNoteTwice() throws Exception {
        ...
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/whatisnew/text?package=package.A.B&version=0.1.2", String.class)).contains("{\"text\":\"\"}");
        ...
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/whatisnew/text?package=package.A.B&version=0.1.2", String.class)).contains("{\"text\":\"test012OK\"}");
    }
}
